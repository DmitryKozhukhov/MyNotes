                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for (DocumentSnapshot snapshot : documents) {
                            ...
                            result.add(new Note(id, R.drawable.event_note, title, content, createdAt));
                        }
        ...
        db.collection(NOTES)
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        callback.onSuccess(new Note(id, R.drawable.event_note, title, content, createdAt));
        ...
        db.collection(NOTES)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        callback.onSuccess(new Note(id, R.drawable.event_note, newTitle, newContent, new Date()));
                    }
                });
    }
}
